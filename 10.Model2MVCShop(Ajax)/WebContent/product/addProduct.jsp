...
<script type="text/javascript">
	...
	$(function() {
		 $( "td.ct_btn01:contains('확인')" ).on("click" , function() {
				...
				$(window.parent.frames["rightFrame"].document.location).attr("href","/product/listProduct/manage");				$("location").attr('href',"../product/addProductView.jsp");
		});
	});
	...
	$(function() {
		 $( "td.ct_btn01:contains('추가등록')" ).on("click" , function() {
				...
				$(window.parent.frames["rightFrame"].document.location).attr("href","../product/addProductView.jsp");				$("location").attr('href',"../product/addProductView.jsp");
		});
	});
